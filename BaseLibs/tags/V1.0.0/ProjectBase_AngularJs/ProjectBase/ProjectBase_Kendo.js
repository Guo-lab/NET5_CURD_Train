(function (String, angular) {
    ...
    //<------------------------kendo service--------------------------------------------------
    var kendoFn = ['pb', '$state', '$translate', '$timeout', function (pb, $state, $translate, $timeout) {
        ...
        var KendoSelectable = function (controller, fnItemFilter, initialSelection) {
            ...
            if (initialSelection) {
                ...
                selectedObjectList = initialSelection.map(function (x) { return c.DataSource.data().find(function (y) { return y.Id == x }) });
            } else {
                selectedList = [];
                selectedObjectList = [];
            };
            ...
            var addRemoveItem = function (item) {
                ...
                if (index == -1 && item.Selected) {
                    ...
                    var sourceItem = controller.DataSource._pristineData.find(function (x) { return x.Id == item.Id });
                    selectedObjectList.push(sourceItem);
            ...
            controller.GetSelectionObject = function () {
