...
{
    /// <summary>
    /// 该类除SurfixForDisplay外其它应该不会再用到，将来确认后可以删除
    /// </summary>
    [Obsolete]
    public static class DisplayExtension
    {
        ...
        //    //string enumName = enumValue.GetType().ReflectedType.Name +"."+ enumValue.GetType().Name + "." + enumValue.ToString();
        //    string enumName = enumValue.GetType().Name + "." + enumValue.ToString();
        ...
        public static Object Display(this Object value)
        {
            ...
            //    return viewdata.ModelMetadata.DisplayFormatString == null ? Display(viewdata.Model) : Display(viewdata.Model, viewdata.ModelMetadata.DisplayFormatString);
            //}
