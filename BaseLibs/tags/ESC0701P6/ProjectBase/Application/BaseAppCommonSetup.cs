...
namespace ProjectBase.Application
{
    public abstract class BaseAppCommonSetup : IAppCommonSetup
    {
        ...
        protected virtual IEnumerable<string> GetNonprefixMvcModuleNames()
        {
            return new string[] { };
        }
        ...
        /// 启用开发工具
        /// </summary>
        /// <param name="nonprefixMvcModuleNames"></param>
        protected void EnableDevTool(params string[] nonprefixMvcModuleNames)
        {
            ProjectHierarchy.NamespaceMapToTablePrefix = GetNamespaceMapToTablePrefix();
            if (nonprefixMvcModuleNames != null)
            {
                ProjectHierarchy.NonprefixMvcModuleNames = nonprefixMvcModuleNames;
            }
            else
            {
                ProjectHierarchy.NonprefixMvcModuleNames = GetNonprefixMvcModuleNames();
            }
        }
        ...
        public virtual void SetupCommonFeature()
        {
            InitLog4net();
            AddComponentsTo();
        ...
        {
            CastleWindorComponentRegistrar.AddComponentsTo(WindsorContainer, GetDomainModelMappingAssemblies());
        }
        ...
        protected virtual void InitAutoMapper(IServiceCollection services)
        {
            ...
            AutoMapperProfile.ViewModelMappingAssemblies = GetViewModelMappingAssemblies();
        ...
        protected virtual string[] GetViewModelMappingAssemblies()
        {
