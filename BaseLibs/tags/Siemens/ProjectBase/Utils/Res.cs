...
namespace ProjectBase.Utils
{
    public class Res
    {//TODO:暂无使用 服务器语言翻译
        public static IHttpContextAccessor Hca { get; set; }
        ...
        {
            var value = resourceName;// Hca.HttpContext..GetGlobalResourceObject(ProjectHierarchy.DisplayNameResourceClassKey, resourceName,                                                    CultureInfo.CurrentCulture) as string;
            if (value == null)
                value = resourceName;
            return value;
        }
        ...
        {
            var s= resourceName;//HttpContext.GetGlobalResourceObject(ProjectHierarchy.MessagesResourceClassKey, resourceName,            CultureInfo.CurrentCulture) as string;
        ...
        {
            var s = resourceName;// HttpContext.GetGlobalResourceObject(ProjectHierarchy.ValidationMessagesResourceClassKey, resourceName,            CultureInfo.CurrentCulture) as string;
