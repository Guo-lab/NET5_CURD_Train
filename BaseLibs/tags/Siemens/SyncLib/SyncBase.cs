...
namespace SyncLib
{
    public abstract class SyncBase<T,IdT,DtoT>: ISynchronizeHandler where T : BaseDomainObjectWithTypedId<IdT>, ICanSynchronize
    {
        ...
        public IGenericDaoWithTypedId<T, IdT> dao { get; set; }
        public virtual string OrderType
        {
            get; set;
        }
        public virtual void ManualCreateProperty(T order, DtoT orderDTO)
        {
