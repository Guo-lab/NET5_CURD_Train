...
{
    public class AttachmentVM:ISelfMapper<Attachment>,ISelfMapper<IAttachment>
    {
        public AttachmentVM() { }
        ...
        public string src
        {
            get
            {
                return "../" + this.SavedFolder + "\\" + this.SavedFileName;
            }
        }
        ...
        public void Map(IAttachment attachment)
        {
            this.OriginalFileName = attachment.Attachment.OriginalFileName;
            this.SavedFileName = attachment.Attachment.SavedFileName;
        }
