...
namespace ProjectBase.Web.Mvc
{
    public class BaseWebAppSpecialSetup : IAppSpecialSetup
    {
        ...
        {
            RegisterComponents();
            string securityLevel = Configuration["AppSetting:SecurityLevel"];
            if (!string.IsNullOrEmpty(securityLevel))
            {
                SecurityProtocolType protocol;
                if (Enum.TryParse(securityLevel, out protocol))
                {
        ...
        protected virtual void RegisterComponents()
        {
            WindsorContainer.Register(
                Component.For(typeof(ISessionStorage))
                    ...
                    .LifestyleSingleton(),
                Component.For(typeof(IModelBindingUtil))
                    .ImplementedBy(typeof(MvcModelBindingUtil))
                );
        }
        ...
        protected virtual void ConfigMvc(IServiceCollection services)
        {
            ...
            services.Configure<MvcOptions>((o) =>
            {
                ...
                o.ValueProviderFactories.Add(new ValueInFileValueProviderFactory());
            });
