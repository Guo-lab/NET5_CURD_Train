(function (String, angular) {
    ...
    pbm.controller("BaseCtrl", ['$rootScope','$window', '$state', 'pb', 'pbui', '$translate', '$log',  'AppConst', 'App_Dict', 'App_MenuData', 'App_FuncTree',
        function ($rootScope, $window, $state, pb, pbui, $translate, $log, AppConst, App_Dict, App_MenuData, App_FuncTree) {
            var c = this;
            c.IsRecognizedAsDialogController = true;//弹窗的controller()总是最外层的controller
            ...
            $rootScope.pbvar.AppConst=AppConst
            ...
            c.InitMenu = function (allowedFuncList, menuData) {
                var SetMenuItem = function (parentMenuItem, subMenuItem) {
                    ...
                    if (hideMenu == false) {
                        ...
                        if (subMenuItem.pageLink) {
                            link = " ng-href='" + subMenuItem.pageLink + "' target=_blank"
                        }
                        else {
                ...
                angular.forEach(c.menuData, function (menuitem) {
                    var m=null;
                    if (menuitem.subMenus && (menuitem.productCode==null || menuitem.productCode==c.ProductCode)) {
            ...
            c.test = function (any) {
                angular.element('a').attr('style', 'display:block');
                angular.element('button').attr('style', 'display:block');
                //$window.alert('bingo');
            };
        }]);
