...
namespace ImportLibrary
{
                                                             ...
                                                             where ResultT : BaseImportResult<T>, new()
    {
        ...
        public void SetImportParameters(IDictionary<string, object> importParameters)
        {
            this.ImportParametersMap = importParameters;
        }
        ...
        public FeedbackResult<TImportItem> Import<TImportItem>() where TImportItem:BaseImportItem
        {
            var feedback = Import2();

            return feedback as FeedbackResult<TImportItem>;
        }

        public object Import2()
        {
            Result.ImportItems = (IEnumerable<T>)FileParser.Parse();
